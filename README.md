...
- `environments` contains the definitions of the custom grid-worldenvironments used for training and evaluation.
...
```
## Acknowledgments
The AZ code in this repository is partly based on the implementation provided in the [GeneralAlphaZero](https://github.com/albinjal/GeneralAlphaZero) repository.