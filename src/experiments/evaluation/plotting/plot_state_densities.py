...
from utils.plot_density_utils import (
    invert_grid_coordinate,
    calculate_density,
    plot_density
)
...
def create_average_density_visualizations(run_config, root_state, train_seeds, eval_seeds):
    ...
    for train_seed in train_seeds:
        ...
        if hparams["map_size"] == 8 and hparams["train_config"] == "MAZE_RL":
            hparams["model_file"] = f"weights/AZTrain_env=8x8_MAZE_RL_evalpol=visit_iterations=150_budget=64_df=0.95_lr=0.001_nstepslr=2_c=0.5_seed={train_seed}/checkpoint.pth"
        elif hparams["map_size"] == 8 and hparams["train_config"] == "MAZE_LR":
            hparams["model_file"] = f"weights/AZTrain_env=8x8_MAZE_LR_evalpol=visit_iterations=100_budget=64_df=0.95_lr=0.001_nstepslr=2_c=0.5_seed={train_seed}/checkpoint.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--planning_budget", type=int, default = 512, help="Planning budget")
    ...
    # Additional parameters for ExtraDeepMCTS
